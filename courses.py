#Name: Dustin Bowyer
#Program PurposeL: This program uses PYTHON SETS to display PVCC
...
info_req = {'CSC 110', 'ENG 111', 'ENG 112', 'ETR 149', 'ETR 164', 'IDT 110',
...
def process_network_courses():
    ...
    for course in network_elect:
        asterisk_courses = "*" + course #insert an asterisk in front of ELECTIVE course name
        temp_set.add(asterisk_courses)#then add the new course name to a temporary set
...
def display_network_courses():
    ...
    out.write("\nNumber of elected courses   : " + str(num_net_elect))
    ...
    for course in all_net_courses: #Display 5 courses per line
        ...
        if num % 5 == 0:
            out.write("\n")
    out.write("\nNOTES:")
    out.write("\n  *Asterisk indicates ELECTIVE courses")
    out.write("\n  Students choose 3 tecnhical elective courses")
    out.write(dash_line)

def process_info_courses():
    #student: add code for processing info course here WORKING
...
def display_info_courses():
    #student: add code for printing course info here WORKING
    out.write("\nASSOCIATE:Information Technology ")
    out.write(dash_line)
    out.write("\nNumber of required courses  : " + str(num_info_req))
    out.write("\nNumber of elected courses   : " + str(num_info_elect))
